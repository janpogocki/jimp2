...
ostream& operator<<(ostream& out, aghException& exception)
{
     out << "Error in " << exception.errorFile() << " file at " << exception.errorLine() << " line.\nError code: " << exception.errorCode() << " (" << exception.errorMessage() << ").";
     return out;
}
// --------------------------------------------------------------
